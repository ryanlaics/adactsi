...
def has_graph_support(model_cls):
    return model_cls in [models.PoGeVon]


def get_model_classes(model_str):
    model, filler = models.MyImputer, fillers.Filler
    return model, filler


def get_dataset(args, dataset_name):
    dataset = datasets.MissingValuesPems(args.subdataset_name, p_fault=0., p_noise=0.25)
    return dataset
...
def parse_args():
    ...
    parser.add_argument("--model-name", type=str, default='mymodel')
...
def run_experiment(args):
    ...
    args.window=24
    # print('gpu',args.gpu)
    # print('subdataset_name',args.subdataset_name)
    # print('args.epochs',args.epochs)
    # print('args.lr',args.lr)
    # print('args.window',args.window)
